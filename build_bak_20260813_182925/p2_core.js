...
const STAGES = [
  ...
  { name:'深渊核心', sub:'ABYSSAL CORE', accent:'#b980ff', bg:0x0c0614, fog:0x140820,
    ...
    pool:['phaser','brute','sniper','turret','mender','wasp','orbiter'] },
];
